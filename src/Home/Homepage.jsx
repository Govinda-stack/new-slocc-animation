...
const containerRefs = useRef(null);
  ...
  useEffect(() => {
    ...
    // Smooth color change with zoom and fade effect
    ScrollTrigger.create({
      trigger: welcomeTextRef.current,
      start: 'top-=200 top', // Trigger 200px before it reaches top
      toggleActions: 'play none none reverse',
      onEnter: () => {
        // Smooth color transition with zoom-in effect
        gsap.to(paths, {
          fill: '#064685',
          stroke: '#064685',
          scale: 1.1, // Slight zoom-in
          opacity: 0.8, // Subtle fade
          duration: 0.4, // Smooth timing
          ease: 'power2.out',
          onComplete: () => {
      ...
      onLeaveBack: () => {
        // Smooth reverse transition with zoom-out effect
        gsap.to(paths, {
          fill: 'transparent',
          stroke: 'black',
          scale: 0.9, // Slight zoom-out
          opacity: 0.8,
          duration: 0.4,
          ease: 'power2.out',
          onComplete: () => {
